...
public class ExcelUtility {
     ...
     * @throws Exception If there's an error accessing the cell data.
     */
...
//            } catch (Exception e) {
//                // read data as date, if there's exception catch that
//                cell = workSheet.getRow(rowNum).getCell(colNum);
...
//    }
    ...
    public static Object getCellData(int rowNum, int colNum) {
        try {
            ...
            switch (cell.getCellType()) {
                ...
                case BLANK:
                    return ""; // or handle blank cells as needed
                default:
    ...
    public static void printAllDatFromExcelFile(String filePath, String sheetName) {
        // try with resources
